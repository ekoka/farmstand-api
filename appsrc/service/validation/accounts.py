...
from . import (
    set_domain, check_uuid4,  set_uuid, upper, remove, set_value, ExtraProperties)
from appsrc.utils import password as pwd
...
new_account_via_email = obj(
    ...
    prim(vld.optional(default=set_value(None)),
         vld.rejectempty(failsafe=set_value(None))).apply_to('name'),
...
edit_account = obj(
    prim(vld.optional, vld.allowempty).apply_to('name'),
