...
from .utils import localize_data, delocalize_data, StripeContext, run_or_abort
...
def post_domain(data, access_token, lang):
    # api
    #TODO: Validation
    fnc = lambda: create_domain(data, access_token, lang)
...
def get_domains(access_token, lang):
    # api
    fnc = lambda: get_domains(access_token, lang)
